...
locate_source <- function(s) {
  if (data_source_is_s3)
    myPath <- paste0("C:/Users/Data 1/Desktop/", s)
  else
...
large_test <-  c(locate_source("citibike/2013-07.csv"),
                 locate_source("citibike/2013-08.csv"),
                 locate_source("citibike/2013-09.csv"),
                 locate_source("citibike/2013-10.csv"),
                 locate_source("citibike/2013-11.csv"),
                 locate_source("citibike/2013-12.csv"),
                 locate_source("citibike/2014-01.csv"),
                 locate_source("citibike/2014-02.csv"),
                 locate_source("citibike/2014-03.csv"),
                 locate_source("citibike/2014-04.csv"),
                 locate_source("citibike/2014-05.csv"),
                 locate_source("citibike/2014-06.csv"),
                 locate_source("citibike/2014-07.csv"),
                 locate_source("citibike/2014-08.csv"))
...
wthr1 <- h2o.importFile(path =
                          c(locate_source("citibike/31081_New_York_City__Hourly_2013.csv"),
                            locate_source("citibike/31081_New_York_City__Hourly_2014.csv")))
